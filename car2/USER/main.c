...
extern volatile float global_angle = 0.0;  //偏航角
...
//				OLED_ShowFloatNum(48,0,global_angle,3,2,8);
//				OLED_ShowString(0,16,"YA:",8);
//				OLED_ShowFloatNum(30,16,angular_velocity_y,3,3,8);
//				OLED_ShowString(0,32,"ZA:",8);
//				OLED_ShowFloatNum(30,32,angular_velocity_z,3,3,8);	
